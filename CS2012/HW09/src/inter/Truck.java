...
public class Truck implements Vehicle{
	...
	public void speed() {
		...
		double randomTspeed = 100 + spd.nextInt(501); 
        int speed = (int) Math.max(randomTspeed, randomTspeed/weight);
	...
	public String toString() {
	    return "Truck Name: " + name + ", Color: " + color + ", Speed: " + speed + " MPH"+ ", Weight: " + weight;
	}	
}
